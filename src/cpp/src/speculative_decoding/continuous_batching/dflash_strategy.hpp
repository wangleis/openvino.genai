...
protected:
    std::shared_ptr<ContinuousBatchingPipeline::ContinuousBatchingImpl> m_main_cb_pipeline;

public:
    DFlashDecodingImpl(const ov::genai::ModelDesc& main_model_desc, const ov::genai::ModelDesc& draft_model_desc);
