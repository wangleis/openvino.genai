...
class GeneratedEmbeddingMergerModule : public IBaseModule {
    DeclareModuleConstructor(GeneratedEmbeddingMergerModule);
...
REGISTER_MODULE_CONFIG(GeneratedEmbeddingMergerModule);
