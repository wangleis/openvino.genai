...
class GeneratedPromptEncoderModule : public IBaseModule {
    DeclareModuleConstructor(GeneratedPromptEncoderModule);
...
REGISTER_MODULE_CONFIG(GeneratedPromptEncoderModule);
